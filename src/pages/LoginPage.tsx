  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50 dark:bg-gray-900">
      <header className="p-4 flex justify-between items-center">
        <Logo />
        <Link to="/" className="text-gray-600 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-400 flex items-center gap-1">
          <FiArrowLeft size={16} />
      ...
      <div className="flex-grow flex items-center justify-center px-4 py-12">
        <motion.div 
          ...
          className="bg-white dark:bg-gray-800 shadow-xl rounded-lg w-full max-w-md p-8 md:p-10"
        >
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold">Welcome back</h1>
            <p className="text-gray-600 dark:text-gray-300 mt-2">Log in to your Captly account</p>
          </div>
